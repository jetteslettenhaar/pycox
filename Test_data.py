...
class SurvivalDataset(Dataset):
    ...
    def __init__(self, is_train, threshold_value=8760, sampling=None):
        ...
        self.input_dim = len(self.selected_features)  # Store the filtered feature dimension
...
if __name__ == "__main__":
    ...
    print(train_dataset.input_dim)
    test_dataset = SurvivalDataset(is_train=False)
    print(test_dataset.input_dim)
    ...
    # Create and train the model with the chosen hyperparameters
    final_model_shap = Survivalmodel(input_dim=int(train_dataset.input_dim), dim_2=dim_2, dim_3=dim_3, drop=drop, l2_reg=l2_reg)
